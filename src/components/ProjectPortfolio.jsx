...
const highlights = [
  ...
  {
    id: "03",
    title: "WebGL-шейдер + Canvas 2D в одной секции",
  ...
  {
    id: "06",
    title: "Hero: глобус, шейдер, direction-aware анимация",
    text: "WebGL-глобус из трёх параллелей и трёх меридианов — рендерится в <canvas> 48px внутри fixed UI-элемента. Marquee знает, куда ты тянешь окно. Popup не исчезает при переходе между кнопкой и ссылкой — setTimeout + clearTimeout, два года как стандарт, многие до сих пор не делают.",
    mediaLabel: "WebGL · rAF · UX detail",
    media: null,
