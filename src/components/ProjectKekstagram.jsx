      ...
      <section className="pkg__intro">
        <div className="pkg__intro-grid">
          <div className="pkg__intro-text">
            ...
            <p>
              Проект сделан в рамках профессионального курса по JavaScript. Код разбит на модули, работает кроссбраузерно и не оставляет «мусорных» обработчиков событий.
            </p>
          </div>
