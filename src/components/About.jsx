          ...
          >
            ...
            <div className={styles.textCard}>
              ...
              <p className={styles.textBody} ref={textRef}>
                ...
                <br /><br />
                Сначала я увлёкся 3D в Blender — это дало мне чувство формы и пространства.
                Потом полгода самостоятельно осваивал вёрстку и JavaScript,
                а после закрепил всё на годовых курсах.
              </p>
