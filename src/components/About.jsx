          ...
          >
            ...
            <div className={styles.textCard}>
              ...
              <p className={styles.textBody} ref={textRef}>
                ...
                Около Полугода самостоятельно осваивал вёрстку и JavaScript по туториалам и видео на YouTube, понял, что завлекло и нравится. Потом решил  по-серьезнее - пройти годовые курсы. 
