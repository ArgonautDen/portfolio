          ...
          >
            ...
            <div className={styles.textCard}>
              <div className={styles.textCardHeader}>
                ...
                <span className={styles.textCardIndex}>01 / 04</span>
              </div>
              <p className={styles.textBody} ref={textRef}>
                Привет! Я Денис, начинающий фронтенд‑разработчик.
                <br /><br />
                Сначала я увлёкся 3D в Blender, но понял, что это слишком творческое занятие, а хочется что-то на стыке конркетики, входящих данных и творчества - в итоге нашел все это во фронтенде.
                Полгода самостоятельно осваивал вёрстку и JavaScript,
                после решил пройти годовые курсы. Далее практики, всевозможные стажировочные задачи, сайты для друзей из разных сфер и работа над онлайн игрой.
              </p>
